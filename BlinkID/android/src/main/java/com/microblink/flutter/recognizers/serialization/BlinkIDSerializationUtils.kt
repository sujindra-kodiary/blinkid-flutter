...
object BlinkIDSerializationUtils {
    ...
    fun serializeMrzResult(mrzResult: MrzResult): JSONObject {
        val jsonMrz = JSONObject()
    ...
    @Throws(JSONException::class)
    fun serializeDriverLicenseDetailedInfo(dlDetailedInfo: DriverLicenseDetailedInfo): JSONObject {
        val jsonDriverLicenseDetailedInfo = JSONObject()
    ...
    @Throws(JSONException::class)
    fun serializeClassInfo(classInfo: ClassInfo): JSONObject {
        val jsonClassInfo = JSONObject()
    ...
    @Throws(JSONException::class)
    fun serializeImageAnalysisResult(imageAnalysisResult: ImageAnalysisResult): JSONObject {
        val jsonImageAnalysis = JSONObject()
    ...
    @Throws(JSONException::class)
    fun serializeVizResult(vizResult: VizResult): JSONObject {
        val jsonViz = JSONObject()
    ...
    @Throws(JSONException::class)
    fun serializeBarcodeResult(barcodeResult: BarcodeResult): JSONObject {
        val jsonBarcode = JSONObject()
